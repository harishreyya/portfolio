      ...
      <div className="FormDiv">
        ...
        <form className="FormDiv-inputdiv" onSubmit={handleSubmit}>
          <div>
            ...
            <label htmlFor="name">Name : Reyya Harish</label>
           
          
          </div>
          
          <div>
            <label htmlFor="email">Email : harishrebel0@gmail.com</label>
            
           
          </div>
          <div>
            <label htmlFor="subject">Phone : +917002092915</label>
           
           
          
          </div>
          <div>
            <label htmlFor="message">Address : Palasa, Andhra Pradesh</label>
